...
path = '/Users/aphiwutjanphet/Documents/internship/Business Local/github/scrapingbusinesslocal/combined/output/summarized_content_20240910_144614.csv'
try:
...
for index, row in df.iterrows():
    ...
    # Add extracted data and found flags to the new row
    for key, value in extracted_data.items():
        new_row[key] = value
    
    # Add found flags to the new row
    for key, value in found_data.items():
        new_row[key] = value

    # Append the modified row (with both the original data, extracted data, and found flags) to output_rows
...
print(f"Saved the cleaned content with original columns and found flags to {output_filename}")
